  ...
  describe('/countries', () => {
    ...
    describe('/country', () => {
        describe('/:_id', () => {
            describe('/ - GET', () => {
                describe('status 200 - Success', () => {
                    test('returns the country using the country id', () => {
                        return request(app)
                            .get('/api/countries/country/123a')
                            .expect(200)
                            .then((res: any) => {
            ...
            describe('/ - PATCH', () => {
                describe('status 200 - Success', () => {
                    test('returns the updated country using the id when passing in a new country object', () => {
                        return request(app)
                            .patch('/api/countries/country/123a')
                            .send({country: {
                                "country": "Portugal",
                                "colorList": "green",
                                "entryRequirements": {
